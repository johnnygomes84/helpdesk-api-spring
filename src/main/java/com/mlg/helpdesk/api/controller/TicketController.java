package com.mlg.helpdesk.api.controller;
...
import com.mlg.helpdesk.api.dto.Summary;
import com.mlg.helpdesk.api.entity.ChangeStatus;
import com.mlg.helpdesk.api.entity.Ticket;
import com.mlg.helpdesk.api.entity.User;
import com.mlg.helpdesk.api.enums.ProfileEnum;
import com.mlg.helpdesk.api.enums.StatusEnum;
import com.mlg.helpdesk.api.response.Response;
import com.mlg.helpdesk.api.security.jwt.JwtTokenUtil;
import com.mlg.helpdesk.api.service.TicketService;
import com.mlg.helpdesk.api.service.UserService;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> findById(@PathVariable("id") String id) {
		...
		if (ticket == null) {
			response.getErrors().add("Ticket not found id: " + id);
			return ResponseEntity.badRequest().body(response);
		}
